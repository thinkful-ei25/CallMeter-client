		...
		return (
            ...
            <div className="background">
                ...
                <div className="centerMainImageContainer">
                    <img  alt='main-img' src='https://images.pexels.com/photos/1253591/pexels-photo-1253591.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'></img>
                </div>
				...
				<div className="featureContainer">
					<div className="featureBox">
						<img alt='feature' className="featureImages" src='https://openclipart.org/image/2400px/svg_to_png/399/molumen-phone-icon.png'></img>
						<h3>Track Calls</h3>
					...
					<div className="featureBox">
						<img alt='feature' className="featureImages" src='https://cdn2.iconfinder.com/data/icons/transports-2/200/Untitled-4-512.png'></img>
					...
					<div className="featureBox">
						<img alt='feature' className="featureImages" src='https://cdn0.iconfinder.com/data/icons/business-and-finance-vol-2-1/48/101-512.png'></img>
